...
import kotlinx.android.synthetic.main.activity_spiderman_intent.*
import kotlinx.android.synthetic.main.activity_spiderman_intent.playbutton
import kotlinx.android.synthetic.main.activity_spiderman_intent.savebutton

class spidermanIntent : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        val binding= ActivitySpidermanIntentBinding.inflate(layoutInflater)
        setContentView(binding.root)

        savebutton.setOnClickListener {
            Toast.makeText(this@spidermanIntent,"저장은 모태요^_ㅜ", Toast.LENGTH_LONG).show()
        }

        playbutton.setOnClickListener {
            var intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=mO168Yp2IF0"))
